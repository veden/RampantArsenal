...
local function onConfigChanged()
    ...
    if (world.version < 15) then
        ...
        world.count = nil
        world.areaTop = nil
        world.areaBottom = nil
        world.area = nil

        world.mineChecks = nil
        world.mineCheckNextTick = nil
        -- world.airFilterTick = {}
        ...
        for i,p in ipairs(game.connected_players) do
            p.print("Rampant Arsenal - Version 1.0.0")
        end
        world.version = 15
    end
end
...
local function onTriggerEntityCreated(event)
    ...
    if entity and entity.valid then
        if (entity.name == "small-repair-cloud-rampant-arsenal") then
