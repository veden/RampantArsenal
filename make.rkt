...
(module BuildScript racket
  ...
  (define modFolder "/data/games/factorio016/factorio/mods/")
  (define zipModFolder "/data/games/factorio016/factorio/mods/")
  ...
  (define (runStart)
   ;; (copyFiles modFolder)
    ...
    (makeZip modFolder)
    (system*/exit-code "/data/games/factorio016/factorio/bin/x64/factorio"))
